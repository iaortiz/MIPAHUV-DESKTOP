...
class SearchedListSoftware extends StatefulWidget {
  String value;
  SearchedListSoftware(String value) {
    this.value = value;
  }

  @override
  _SearchedListSoftwareState createState() => _SearchedListSoftwareState();
}

class _SearchedListSoftwareState extends State<SearchedListSoftware> {
